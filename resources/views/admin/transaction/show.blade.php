    ...
    <div class="col-md-12">
        <div class="card border-0 shadow rounded">
            <div class="card-body">
                ...
                @endif
                <form action="/admin/transaction/update" method="POST" class="row">
                    @csrf
                    @method('PUT')
                  <input type="hidden" name="id" value="{{ $data_header->id }}">
                  <div class="col-6">
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-10">
                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="5">{{ $data_header->description }}</textarea>
                        @error('description')
                  ...
                  <div class="col-6">
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-10">
                        <select class="form-control form-select @error('code') is-invalid @enderror" name="code">
                          <option value="123456" {{ ($data_header->code == '123456') ? 'selected' : ''  }}>123456</option>
                          <option value="7890" {{ ($data_header->code == '7890') ? 'selected' : ''  }}>7890</option>
                        </select>
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-10">
                        <input type="number" class="form-control @error('rate_euro') is-invalid @enderror" name="rate_euro" value="{{ $data_header->rate_euro }}" >
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-10">
                        <input type="date" class="form-control @error('date_paid') is-invalid @enderror" name="date_paid" value="{{ Carbon\Carbon::parse($data_header->date_paid)->format('Y-m-d') }}" >                    
                        <!-- error message untuk rate_euro -->
                        @error('date_paid')
                          <div class="invalid-feedback mt-2">
                              {{ $message }}
                  ...
                  <div class="container">
                    <div class="card bg-default mb-3">
                      ...
                      <div class="card-body text-dark">
                        @foreach($data_detail as $d => $detail)
                          ...
                          <div class="form-group row mt-3 mb-3">
                            ...
                            <div class="col-7">
                              ...
                              <select class="form-control form-select mb-3" name="kategori[]">
                                ...
                                <option value="{{ $k->id }}" {{ ($detail->transaction_category_id == $k->id) ? 'selected' : ''  }}>{{ $k->name }}</option>
                                @endforeach
                              </select>
                              ...
                              <table class="table table-striped table-bordered" id="tabel-dt">
                                ...
                                <tr>
                                  <td>
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name[]" value="{{ $detail->name }}" required> 
                                    @error('name')
                                      <div class="invalid-feedback mt-2">
                                          {{ $message }}
                                      </div>
                                  ...
                                  <td>
                                    <input class="form-control @error('value_idr') is-invalid @enderror" type="number" name="value_idr[]" value="{{ $detail->value_idr }}" required>
                                    @error('value_idr')
                                      <div class="invalid-feedback mt-2">
                                          {{ $message }}
                                      </div>
                  ...
                  <div class="btn-group">
                    ...
                    <a href="/admin/transaction" class="btn btn-warning">CANCEL</a>
